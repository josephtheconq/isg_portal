...
class NWGPersonelEvrakTakipScreen extends ConsumerStatefulWidget {
  const NWGPersonelEvrakTakipScreen({super.key});

  @override
  ConsumerState<NWGPersonelEvrakTakipScreen> createState() => _NWGPersonelEvrakTakipScreenState();
}

class _NWGPersonelEvrakTakipScreenState extends ConsumerState<NWGPersonelEvrakTakipScreen> {
