            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Personnel table
                  Container(
                    height: 600,  // Fixed height for the table container
                    width: double.infinity,
                    decoration: BoxDecoration(
                      color: const Color(0xFF2A2D3E),
                      borderRadius: BorderRadius.circular(4),
                      ...
                      child: SingleChildScrollView(
                        child: DataTable(
                          ...
                          rows: [
                            ...
                            DataRow(cells: [
                              const DataCell(Text('125478')),
                              const DataCell(Text('Deniz Yıldırım')),
                              const DataCell(Text('12345678922')),
                              const DataCell(Text('Kadın')),
                              const DataCell(Text('Üretim Sorumlusu')),
                              const DataCell(Text('+90 533 111 2233')),
                              DataCell(Icon(Icons.check_circle, color: Colors.green[400], size: 20)),
                              DataCell(Icon(Icons.star, color: Colors.orange[400], size: 20)),
                              DataCell(Icon(Icons.check_circle, color: Colors.green[400], size: 20)),
                              const DataCell(Icon(Icons.visibility_outlined, color: Colors.blue, size: 20)),
                            ...
                            DataRow(cells: [
                              const DataCell(Text('125479')),
                              const DataCell(Text('Kemal Özdemir')),
                              const DataCell(Text('12345678923')),
                              const DataCell(Text('Erkek')),
                              const DataCell(Text('Kalite Kontrol')),
                              const DataCell(Text('+90 542 444 5566')),
                              DataCell(Icon(Icons.warning_amber, color: Colors.orange[400], size: 20)),
                              DataCell(Icon(Icons.star_border, color: Colors.orange[400], size: 20)),
                              DataCell(Icon(Icons.warning_amber, color: Colors.orange[400], size: 20)),
                              const DataCell(Icon(Icons.visibility_outlined, color: Colors.blue, size: 20)),
                            ...
                            DataRow(cells: [
                              const DataCell(Text('125480')),
                              const DataCell(Text('Ayşe Çelik')),
                              const DataCell(Text('12345678924')),
                              const DataCell(Text('Kadın')),
                              const DataCell(Text('İnsan Kaynakları')),
                              const DataCell(Text('+90 535 777 8899')),
                              DataCell(Icon(Icons.check_circle, color: Colors.green[400], size: 20)),
                              DataCell(Icon(Icons.star, color: Colors.orange[400], size: 20)),
                              DataCell(Icon(Icons.check_circle, color: Colors.green[400], size: 20)),
                            ...
                            DataRow(cells: [
                              const DataCell(Text('125481')),
                              const DataCell(Text('Mustafa Aydın')),
                              const DataCell(Text('12345678925')),
                              const DataCell(Text('Erkek')),
                              const DataCell(Text('Elektrik Teknisyeni')),
                              const DataCell(Text('+90 532 333 4455')),
                              DataCell(Icon(Icons.check_circle, color: Colors.green[400], size: 20)),
                              DataCell(Icon(Icons.star_border, color: Colors.orange[400], size: 20)),
                              DataCell(Icon(Icons.warning_amber, color: Colors.orange[400], size: 20)),
                              const DataCell(Icon(Icons.visibility_outlined, color: Colors.blue, size: 20)),
                            ...
                            DataRow(cells: [
                              const DataCell(Text('125482')),
                              const DataCell(Text('Zehra Kılıç')),
                              const DataCell(Text('12345678926')),
                              const DataCell(Text('Kadın')),
                              const DataCell(Text('Satın Alma Uzmanı')),
                              const DataCell(Text('+90 536 999 8877')),
                              DataCell(Icon(Icons.warning_amber, color: Colors.orange[400], size: 20)),
                              DataCell(Icon(Icons.star, color: Colors.orange[400], size: 20)),
                              DataCell(Icon(Icons.check_circle, color: Colors.green[400], size: 20)),
                              const DataCell(Icon(Icons.visibility_outlined, color: Colors.blue, size: 20)),
                            ...
                            DataRow(cells: [
                              const DataCell(Text('125483')),
                              const DataCell(Text('Emre Koç')),
                              const DataCell(Text('12345678927')),
                              const DataCell(Text('Erkek')),
                              const DataCell(Text('Lojistik Sorumlusu')),
                              const DataCell(Text('+90 534 222 3344')),
                              DataCell(Icon(Icons.check_circle, color: Colors.green[400], size: 20)),
                              DataCell(Icon(Icons.star, color: Colors.orange[400], size: 20)),
                              DataCell(Icon(Icons.check_circle, color: Colors.green[400], size: 20)),
                              const DataCell(Icon(Icons.visibility_outlined, color: Colors.blue, size: 20)),
                            ...
                            DataRow(cells: [
                              const DataCell(Text('125484')),
                              const DataCell(Text('Sema Arslan')),
                              const DataCell(Text('12345678928')),
                              const DataCell(Text('Kadın')),
                              const DataCell(Text('Muhasebe Uzmanı')),
                              const DataCell(Text('+90 537 666 5544')),
                              DataCell(Icon(Icons.check_circle, color: Colors.green[400], size: 20)),
                              DataCell(Icon(Icons.star_border, color: Colors.orange[400], size: 20)),
                              DataCell(Icon(Icons.warning_amber, color: Colors.orange[400], size: 20)),
                              const DataCell(Icon(Icons.visibility_outlined, color: Colors.blue, size: 20)),
                            ...
                            DataRow(cells: [
                              const DataCell(Text('125485')),
                              const DataCell(Text('Okan Demir')),
                              const DataCell(Text('12345678929')),
                              const DataCell(Text('Erkek')),
                              const DataCell(Text('Bakım Mühendisi')),
                              const DataCell(Text('+90 538 444 3322')),
                              DataCell(Icon(Icons.warning_amber, color: Colors.orange[400], size: 20)),
                              DataCell(Icon(Icons.star, color: Colors.orange[400], size: 20)),
                              DataCell(Icon(Icons.check_circle, color: Colors.green[400], size: 20)),
                              const DataCell(Icon(Icons.visibility_outlined, color: Colors.blue, size: 20)),
