...
class PersonelEvrakTakipScreen extends ConsumerStatefulWidget {
  const PersonelEvrakTakipScreen({super.key});

  @override
  ConsumerState<PersonelEvrakTakipScreen> createState() => _PersonelEvrakTakipScreenState();
}

class _PersonelEvrakTakipScreenState extends ConsumerState<PersonelEvrakTakipScreen> {
  String selectedFirm = 'Firma 1';
  final List<String> firms = ['Firma 1', 'Firma 2', 'Firma 3', 'Firma 4'];
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      _buildProgressCard('Genel Konular', 0.63, const Color(0xFFFF4081)),
                      _buildProgressCard('Sağlık Konuları', 0.87, const Color(0xFF4CAF50)),
                      _buildProgressCard('Teknik Konular', 0.33, const Color(0xFFFF9800)),
                      _buildProgressCard('Saha Kuralları', 0.87, const Color(0xFF2196F3)),
                      _buildProgressCard('Atık Yönetimi', 1.0, const Color(0xFF9C27B0)),
                      _buildProgressCard('Kazaların Duyurulması', 0.63, const Color(0xFFE91E63)),
                      _buildProgressCard('Çevre Yönetimi', 0.87, const Color(0xFF03A9F4)),
                      _buildProgressCard('Tatbikatlar', 0.33, const Color(0xFFFF5722)),
                    ],
                  ),
                ),
                const SizedBox(height: 24),
